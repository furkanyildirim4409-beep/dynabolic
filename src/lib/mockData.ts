...
export const detailedExercises: (ProgramExercise & { targetReps: number; tempo: string; restDuration: number; videoUrl?: string })[] = [
  // --- GÖĞÜS & SIRT (CHEST & BACK) ---
  {
    ...
    notes: "Piramit: 30-12-10-8-6. Barı göğsüne değdir, sektirme yapma!",
    restDuration: 90,
  },
  {
    id: "a2",
    ...
    notes: "Üst göğüs açısı 45 derece. Tişört duracaksa burası çalışacak!",
    restDuration: 90,
  },
  {
    id: "a3",
  ...
  },
  {
    ...
    notes: "Sırt ve göğüs aynı anda çalışır. Efsane genişleme hareketi!",
    restDuration: 90,
  },
  {
    id: "a5",
    ...
    notes: "Çeneni bara vur! Kanatlarını hisset, sırt genişliği burada yapılır.",
    restDuration: 90,
  },
  {
    id: "a6",
    ...
    notes: "Belini düz tut, barı karnına çek. Sırtın harita gibi olacak!",
    restDuration: 60,
  },
  {
    id: "a7",
    ...
    notes: "Karın kaslarını sık. 5 set 25 tekrar, acımak yok!",
    restDuration: 30,
  },

  // --- OMUZ & KOL (SHOULDERS & ARMS) ---
  {
    id: "b1",
    name: "Clean & Press",
    ...
    notes: "Patlayıcı güç! Bu hareket adamı ayırır. AĞIR gir!",
    restDuration: 120,
  },
  {
    id: "b2",
    ...
    notes: "Tam yukarıda birleştirme. Omuz başları yanacak!",
    restDuration: 0,
  },
  {
    id: "b3",
    ...
    notes: "Sallanmadan kaldır, omuzu izole et.",
    restDuration: 90,
  },
  {
    id: "b4",
    ...
    notes: "Dirsekleri sabitle. Cheating yok, belden vurma!",
    restDuration: 60,
  },
  {
    id: "b5",
    ...
    notes: "Triceps odaklı. Dirsekleri vücuda yapıştır!",
    restDuration: 60,
  },
  {
    id: "b6",
    ...
    notes: "Alnına kadar indir. Arnold kolları burada yapılır!",
    restDuration: 60,
  },
  {
    id: "b7",
    ...
    notes: "Bilekleri yak! Kavrama gücün burada başlar.",
    restDuration: 30,
  },
  ...
  // --- BACAK (LEGS) ---
  {
    ...
    notes: "KRAL HAREKET! Derin in, topuklardan it. Bacaklar titreyene kadar!",
    restDuration: 120,
  },
  {
    id: "c2",
    ...
    notes: "Arka bacakları gerdir. Bel düz kalacak!",
    restDuration: 90,
  },
  {
    id: "c3",
    ...
    notes: "Diz yere değmesin. Adımları uzun at!",
    restDuration: 60,
  },
  {
    id: "c4",
    ...
    notes: "Tepede 1 saniye sık. Detaylar orada gizli!",
    restDuration: 0,
  },
  {
    id: "c5",
    ...
    notes: "Kalçayı kaldırma. Tam kapasite çek!",
    restDuration: 90,
  },
  {
    id: "c6",
    ...
    notes: "Tam esnet, tam parmak ucu. Arnold gibi zayıf noktanı yok et!",
    restDuration: 45,
  },
];
...
export const assignedWorkouts = [
  {
    id: "w1",
    title: "Arnold: Gün 1 (Göğüs & Sırt)",
    day: "Pazartesi",
    exercises: 7,
    duration: "75 dk",
    intensity: "Yüksek" as const,
    coachNote: "Haftaya güçlü başla. Süpersetlerde nefesini ayarla.",
    categoryFilter: "chest_back",
  },
  {
    id: "w2",
    title: "Arnold: Gün 2 (Omuz & Kol)",
    day: "Salı",
    exercises: 7,
    duration: "60 dk",
    intensity: "Orta" as const,
    coachNote: "Omuz başlarını hisset. Kollarda cheat yapma.",
    categoryFilter: "shoulder_arm",
  },
  {
    id: "w3",
    title: "Arnold: Gün 3 (Bacak)",
    day: "Çarşamba",
    exercises: 6,
    duration: "80 dk",
    intensity: "Yüksek" as const,
    coachNote: "Squat'ta derin in. Bacaklar titreyene kadar.",
    categoryFilter: "legs",
  },
  {
    id: "w4",
    title: "Arnold: Gün 4 (Göğüs & Sırt)",
    day: "Perşembe",
    exercises: 7,
    duration: "75 dk",
    intensity: "Yüksek" as const,
    coachNote: "İkinci göğüs-sırt günü. Ağırlıkları %5 artır.",
    categoryFilter: "chest_back",
  },
  {
    id: "w5",
    title: "Arnold: Gün 5 (Omuz & Kol)",
    day: "Cuma",
    exercises: 7,
    duration: "60 dk",
    intensity: "Orta" as const,
    coachNote: "Arnold kolları buradan çıkar! Pump alana kadar devam.",
    categoryFilter: "shoulder_arm",
  },
  {
    id: "w6",
    title: "Arnold: Gün 6 (Bacak)",
    day: "Cumartesi",
    exercises: 6,
    duration: "80 dk",
    intensity: "Yüksek" as const,
    coachNote: "Haftanın son bacak günü. Kalf için ekstra setler!",
    categoryFilter: "legs",
  },
  {
    id: "w7",
    ...
    coachNote: "Aktif dinlenme: Hafif yürüyüş, esneme. Kaslar bugün büyüyor!",
    categoryFilter: "rest",
  },
];
