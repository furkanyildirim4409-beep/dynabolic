...
export const detailedExercises: (ProgramExercise & { targetReps: number; tempo: string; restDuration: number })[] = [
  // --- GÜN 1 & 4: GÖĞÜS & SIRT (CHEST & BACK) ---
  {
    ...
    reps: 0,
    rpe: 9,
    notes: "Piramit sistem uygula: 30, 12, 10, 8, 6 tekrar. Ağırlığı her sette artır. Barı göğsüne değdir, sektirme. O göğüsler patlayacak!",
    restDuration: 90,
  },
  {
    id: "arnold_day1_2",
  ...
  },
  {
    ...
    reps: 0,
    rpe: 9,
    notes: "Dumbbell Pullover ile SÜPERSET! Göğüs kafesini iyice aç, akciğerlerin hava dolsun. Kolları kırma.",
    restDuration: 0,
  },
  {
    id: "arnold_day1_4",
    ...
    reps: 0,
    rpe: 8,
    notes: "Flyes ile süperset bitti, şimdi 90sn dinlen. Sırtını ve göğsünü aynı anda genişleten efsane hareket. Belini bükme.",
    restDuration: 90,
  },
  {
    id: "arnold_day1_5",
    ...
    reps: 0,
    rpe: 10,
    notes: "4 set tükenişe kadar! Çeneni bara vurmadan inmek yok. Kanatlarını hisset, sırt genişliği burada yapılır.",
    restDuration: 90,
  },
  {
    id: "arnold_day1_6",
  ...
  // --- GÜN 2 & 5: OMUZ & KOL (SHOULDERS & ARMS) ---
  {
    id: "arnold_day2_1",
    ...
    reps: 0,
    rpe: 9.5,
    notes: "Bu hareket adamı ayırır. Olimpik bir güç istiyorsan hakkını ver. 5 set 5 tekrar, AĞIR gir!",
    restDuration: 120,
  },
  {
    id: "arnold_day2_2",
  ...
  },
  {
    ...
    reps: 0,
    rpe: 8.5,
    notes: "Süperset bitti, 90sn dinlen. Sallanarak kaldırma, omuzu izole et. İyice tepeye kadar kaldır.",
    restDuration: 90,
  },
  {
    id: "arnold_day2_4",
    ...
    reps: 0,
    rpe: 10,
    notes: "Cheating (hile) yok! Belden vurma. 1-10 metodu: Ağırdan hafife durmadan pump al, o bicepsler patlayana kadar!",
    restDuration: 60,
  },
  {
    id: "arnold_day2_5",
    ...
    reps: 0,
    rpe: 9,
    notes: "Arka kol (Triceps) için en baba hareket. Dirsekleri vücuda yapıştır, göğüsten çalma.",
    restDuration: 60,
  },
  {
    id: "arnold_day2_6",
    ...
    reps: 0,
    rpe: 9,
    notes: "Alnına indir, dirsekleri açma. Tricepsler kopana kadar devam, Arnold kolları burada yapılır!",
    restDuration: 60,
  },
  {
    id: "arnold_day2_7",
    ...
    reps: 0,
    rpe: 8,
    notes: "Bilekler önemli, kavrama gücün burada başlar. Yanmayı hisset, bırakma!",
    restDuration: 30,
  },
  ...
  // --- GÜN 3 & 6: BACAK (LEGS) ---
  {
    ...
    reps: 0,
    rpe: 9.5,
    notes: "KRAL HAREKET! Tam çök, yarım yapma. Bacakların titremeli. 8-12 tekrar arası kal, nizami form şart!",
    restDuration: 120,
  },
  {
    id: "arnold_day3_2",
    ...
    reps: 0,
    rpe: 9,
    notes: "Arka bacak (Hamstring) ve kalça için. Dizleri çok kırma, esnemeyi hisset. Bel düz kalacak!",
    restDuration: 90,
  },
  {
    id: "arnold_day3_3",
    ...
    reps: 0,
    rpe: 8.5,
    notes: "Adımları uzun at. Dengeyi koru. Kalçayı sık. Her adım bir şekillendirme!",
    restDuration: 60,
  },
  {
    id: "arnold_day3_4",
    ...
    reps: 0,
    rpe: 9,
    notes: "Leg Curl ile SÜPERSET! Üst noktada bacakları sıkıştır, detaylar orada gizli.",
    restDuration: 0,
  },
  {
    id: "arnold_day3_5",
    ...
    reps: 0,
    rpe: 9,
    notes: "Süperset bitti, 90sn dinlen. Arka bacakları ihmal etme. Tam kapasite çek!",
    restDuration: 90,
  },
  {
    id: "arnold_day3_6",
...
export const assignedWorkouts = [
  // --- ARNOLD 6 GÜNLÜK SPLİT ---
  {
    ...
    coachNote: "Arnold klasik split başlıyor! Göğüs-sırt süpersetleri ile maksimum pump. Piramit sistemle ağırlığı artır.",
  },
  {
    id: "arnold_day2",
    title: "OMUZ & KOL",
    ...
    duration: "70 dk",
    intensity: "Yüksek" as const,
    coachNote: "Clean & Press ile başla, olimpik güç! Biceps-Triceps süpersetleri kolları patlatacak.",
  },
  {
    id: "arnold_day3",
    title: "BACAK",
    ...
    duration: "65 dk",
    intensity: "Yüksek" as const,
    coachNote: "Squat KRAL harekettir! Tam derinlik, nizami form. Bacak günü acı günüdür, kabul et.",
  },
  {
    id: "arnold_day4",
    title: "GÖĞÜS & SIRT",
    ...
    duration: "75 dk",
    intensity: "Yüksek" as const,
    coachNote: "Haftanın ikinci göğüs-sırt günü. Geçen seansa göre ağırlıkları %5 artır.",
  },
  {
    id: "arnold_day5",
    title: "OMUZ & KOL",
    ...
    duration: "70 dk",
    intensity: "Yüksek" as const,
    coachNote: "Arnold kolları buradan çıkar! 1-10 metodu ile biceps, skullcrusher ile triceps yanacak.",
  },
  {
    id: "arnold_day6",
    title: "BACAK",
    ...
    duration: "65 dk",
    intensity: "Yüksek" as const,
    coachNote: "Haftanın son bacak günü. Kalf için ekstra setler ekle, Arnold gibi zayıf noktanı yok et!",
  },
  {
    id: "arnold_rest",
    title: "DİNLENME",
    ...
    coachNote: "Aktif dinlenme: Hafif yürüyüş, esneme, foam roller. Kaslar bugün büyüyor!",
  },
];
