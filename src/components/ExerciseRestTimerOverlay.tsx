  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="mt-4 flex items-center gap-2 px-6 py-3 rounded-xl bg-primary/20 border border-primary/30 text-primary active:bg-primary/30 touch-manipulation"
      >
