                ...
                <div className="p-4 space-y-3">
                  {notifications.map((notification, index) => (
                    <motion.button
                      ...
                      className={`w-full text-left glass-card p-3 border-l-2 ${getStatusColor(notification.status)} hover:bg-white/5 transition-colors ${
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                          ...
                          notification.status === "under_review" ? "bg-blue-500/20" :
                          "bg-yellow-500/20"
                        }`}>
