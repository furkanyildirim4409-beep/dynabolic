        ...
        <div className="p-5">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full grid grid-cols-2 bg-white/[0.03] border border-white/5 p-1 h-12 mb-5">
              <TabsTrigger 
                value="card" 
                className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-medium gap-2"
              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    maxLength={19}
                    className="bg-black/40 border-white/10 text-foreground text-lg tracking-widest h-12 font-mono"
                    autoComplete="off"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      maxLength={5}
                      className="bg-black/40 border-white/10 text-foreground h-12 font-mono tracking-widest"
                      autoComplete="off"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-black/40 border-white/10 text-foreground h-12 uppercase tracking-wide"
                    autoComplete="off"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full h-14 bg-primary text-primary-foreground font-display text-lg tracking-wider hover:bg-primary/90 disabled:opacity-50 mt-2"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/[0.03] border border-white/10 rounded-xl p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <button
                        onClick={() => handleCopy("Referans", bankDetails.referenceCode)}
                        className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 transition-colors text-xs"
                      >
                        {copiedField === "Referans" ? (
                          <Check className="w-3 h-3 text-green-500" />
                        ) : (
                          <Copy className="w-3 h-3 text-muted-foreground" />
                        )}
                ...
                <div className="flex items-start gap-3 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
                  ...
                  <p className="text-sm text-amber-200/80">
                    Havale yaparken <span className="font-bold text-amber-200">referans kodunu</span> açıklama alanına eklemeyi unutmayın.
                  </p>
                </div>
