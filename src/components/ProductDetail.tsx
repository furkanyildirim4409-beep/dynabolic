      ...
      {isOpen && product && (
        ...
        >
          ...
          >
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star 
                        key={star} 
                        className={`w-4 h-4 ${star <= 4 ? "text-yellow-500 fill-yellow-500" : "text-muted-foreground"}`} 
                      />
                    ))}
                  </div>
            ...
            <div className="sticky bottom-0 left-0 right-0 p-4 bg-[#1a1a1a] border-t border-white/10">
